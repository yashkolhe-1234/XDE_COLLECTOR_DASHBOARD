"""
Django management command to import AgriStack data from Excel file.

Usage:
    python manage.py import_agristack /path/to/file.xlsx
    python manage.py import_agristack /path/to/file.xlsx --sheet "Sheet1"
    python manage.py import_agristack /path/to/file.xlsx --no-update
    python manage.py import_agristack /path/to/file.xlsx --validate-only
"""
...
class Command(BaseCommand):
    help = 'Import ॲग्रीस्टॅक (AgriStack) data from Excel file (.xlsx)'
