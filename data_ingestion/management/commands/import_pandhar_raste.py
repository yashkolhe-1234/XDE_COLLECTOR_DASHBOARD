"""
Django management command to import PandharRaste data from Excel file.

Usage:
    python manage.py import_pandhar_raste /path/to/file.xlsx
    python manage.py import_pandhar_raste /path/to/file.xlsx --sheet "Sheet1"
    python manage.py import_pandhar_raste /path/to/file.xlsx --no-update
"""
...
class Command(BaseCommand):
    help = 'Import PandharRaste data from Excel file (.xlsx)'
